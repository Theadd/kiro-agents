...
<!-- 
  ...
  This file is generated by: bun run build:power
  Source files are in: src/
  
  Modifications to this file will be:
  - Overwritten during next build
  - Rejected in Pull Requests (CI will fail)
  - Only updated by maintainers during release
  
  To contribute: Modify files in src/ directory instead
