...
- fb259b6: Simplify kiro-protocols power documentation by removing verbose protocol listings and consolidating structure to reduce context overhead
  docs(kiro-protocols): simplify power documentation and remove legacy files

  - Update POWER.md with concise steering library description
  - Remove verbose protocol overview and best practices sections
  - Simplify usage examples to focus on on-demand loading patterns
  - Remove outdated protocol listings and integration examples
  - Delete legacy src/kiro/POWER.md duplicate file
  - Delete legacy src/kiro/mcp.json configuration file
  - Reduce context overhead by consolidating documentation structure

## 1.15.3

### Patch Changes

- 4922c62: # Fix CLI installation failures on Windows without admin privileges
...
- 819d189: # Fix npm distribution by generating protocols during build
...
- a143f25: # Improve agent-creation Method 2 with architectural analysis approach
...
- b1c37ed: # Fix reflection system enablement clarity and add missing agent management alias
...
- 0839c08: # Fix CLI build system to eliminate redundant file and prevent desynchronization
...
- b7d5050: # Add reflection system and fix agent creation protocol
